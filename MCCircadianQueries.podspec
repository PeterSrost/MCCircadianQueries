#
#  Be sure to run `pod spec lint MCCircadianQueries.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.2.1"
  s.summary      = "part of commands needed for circator"
  ...
  s.description  = <<-DESC
                   a set of query commands for circator
                   DESC
...
#  s.license      = "MIT (example)"
  ...
  s.author             = { "Tom Woolf" => "email@address.com" }
  # Or just: s.author    = "Tom Woolf"
  # s.authors            = { "Tom Woolf" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Tom Woolf"
  ...
  s.source       = { :git => "https://github.com/twoolf/MCCircadianQueries.git", :tag => "#{s.version}" }
